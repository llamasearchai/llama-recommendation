# Contributing to Llama Recommendation

Thank you for your interest in contributing to Llama Recommendation! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Recommendation:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-recommendation.git
   cd llama-recommendation
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-recommendation.git
   ```
...
By contributing to Llama Recommendation, you agree that your contributions will be licensed under the project's MIT License.
