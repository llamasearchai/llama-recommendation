...
class FederatedServer:
    ...
    def _apply_updates(self) -> None:
        ...
        with threading.Lock():
            ...
            self.logger.info(
                f"Applying {len(self.update_buffer)} updates to global model"
            )
            ...
            try:
                ...
                epsilons = [
                    record["privacy"].get("epsilon", 0) for record in self.update_buffer
                ]
                clip_norms = [
                    record["privacy"].get("clip_norm", 0)
    ...
    def get_server_status(self) -> Dict[str, Any]:
        ...
        active_clients = sum(
            ...
            if client["last_update_time"] > active_threshold
        )
