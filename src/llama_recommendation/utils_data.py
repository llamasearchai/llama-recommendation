...
class DataLoader:
        ...
        if path.endswith(".npy") or path.endswith(".npz"):
            ...
            if isinstance(embeddings, np.ndarray):
                if embeddings.ndim == 2:
                    ...
                    embeddings = {
                        f"{entity_type}_{i}": embeddings[i]
            ...
            if isinstance(data["data"], list):
                ...
                for item in data["data"]:
                    ...
                    if (
                        ...
                        or user_col not in item
                        or item_col not in item
                    ):
                        continue
    ...
    def create_train_test_split(
        ...
        if by_user:
            ...
            return self._split_interactions(
                interactions, test_ratio, validation_ratio, seed
            )
    ...
    def _split_interactions(
        ...
        return {
            "train": interactions[split_index:],
            "test": test_set,
